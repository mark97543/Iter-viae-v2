...
export const LAYER_REGISTRY: MapLayerConfig[] = [
    ...
    // --- INFRASTRUCTURE ---
    { id: 'transportation', type: 'line', color: '#5D6D7E', minzoom: 4, maxzoom: HIGH_RES_ZOOM, enabled: true, filter: ['!', ['in', ['get', 'subclass'], ['literal', ['footway', 'service', 'path', 'track']]]]},
    ...
    { id: 'poi', type: 'symbol', color: '#757575', minzoom: 12, maxzoom: HIGH_RES_ZOOM, enabled: true },
