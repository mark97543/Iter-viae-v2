// src/hooks/trip/SubHooks/useTripFileEvents.ts


/**
 * useTripFileEvents.ts
 * @file This hook is responsible for handling file operations related to a trip.
 */
...
export const useTripFileEvents = (tripState: any) => {
    const {
        waypoints,
        setWaypoints,
        tripTitle,
